...
namespace SV20T1020275.DataLayers
{
    public interface IProductDAL
    {
        ...
        /// <param name = "pageSize" > So dòng trên mỗi trang(nếu không phân trang)</param>
        /// <param name="searchValue">Tên mặt hàng cần tìm (chuỗi rồng nếu không tìm kiếm)</param>
        /// <param name="categoryID">Mã loại hàng cần tìm ( nếu không tìm theo loại hàng)</param> /// <param name="supplierID">Mã nhà cung cấp căn tìm (6 nếu không tìm theo nhà cung cấp)</param>
        /// <param name="minPrice">Mức giá nhỏ nhất trong khoảng giá cần tìm</param>
        /// <param name="maxPrice">Mức giá lớn nhất trong khoảng giá cần tìm ( nếu không hạn chế mức giá lớn nhất) </param>
        /// <returns></returns>
        ...
        /// <param name="supplierID">Mã nhà cung cấp cần tìm (8 nếu không tìm theo nhà cung cấp)</param>
        /// <param name="minPrice">Mức giá nhỏ nhất trong khoảng giá cần tìm</param>
        ...
        ///<summary>
        ///Bổ sung thuộc tỉnh cho mặt hàng
        ///</summary>
        ///<param name = "data" ></ param >
        ///< returns ></ returns >
